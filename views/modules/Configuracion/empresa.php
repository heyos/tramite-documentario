                ...
                <div class="col-sm-5">
                    <form id="form-empresa" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input name="nombre" id="nombre" class="form-control validar" type="text" maxlength="19" placeholder="maximo 19 caracteres" value="<?php echo $datosEmpresa->datosEmpresaController('nombre'); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Actividad Economica:</label>
                            <div class="col-sm-8">
                                <input name="actividad_economica" id="actividad_economica validar" class="form-control" type="text" value="<?php echo $datosEmpresa->datosEmpresaController('actividad_economica'); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="direccion" id="direccion" class="form-control validar" value="<?php echo $datosEmpresa->datosEmpresaController('direccion'); ?>">
                            </div>
                        </div>
                        <div class="form-group">
