        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul id="uidemo-tabs-default-demo" class="nav nav-tabs">
                    <li class="active">
                        <a href="#direcciones" id="tab_direccion" data-toggle="tab">Direcciones </a>
                    </li>
                </ul>
...
<div id="modalTablaDetalleContactos" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close close-open" data-open="modalTablaDetalle" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title text-modal-contacto text-bold" id="myModalLabel">Direcciones</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="tab-content tab-content-bordered">
                    <div class="tab-pane fade active in" id="contactos">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form id="form-contacto" class="form-horizontal">
                                    <input type="hidden" name="id" id="id">
                                    <input type="hidden" name="nIdPersona_ref" id="nIdPersona_ref">
                                    <input type="hidden" name="nIdDireccion" id="nIdDireccion">
                                    <input type="hidden" name="accion"  value="addcontacto">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group no-margin-hr">
                                                <label>Contacto</label>
                                                <select class="form-control select2" name="nIdPersona" id="nIdPersona" required="">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group no-margin-hr">
                                                <label>Cargo</label>
                                                <!-- <input type="text" name="cCargo" id="cCargo" class="form-control"> -->
                                                <select class="form-control select2" name="cCargo" id="cCargo" required="">
                                    ...
                                    <div class="form-group">
                                        <div class="text-center">
                                            ...
                                            <button type="submit" class="btn btn-primary">Guardar</button>
                                            <button type="button" data-form="form-contacto" data-accion="addcontacto" class="btn btn-warning nuevoregistro" style="display: none;">Nuevo</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
