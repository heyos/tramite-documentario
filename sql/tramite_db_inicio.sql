...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2020 a las 08:06:38
...
(3, 'HR Menu Manager', '', 'restaurante', 'HR Developer Group', 'empresa_141.jpg', 'Jr Bolognesi 441');
...
(7, 'Configuracion', 'fa fa-cog', '#', 7, '1', '1', '0'),
(14, 'Usuarios', 'fas fa-users', '#', 6, '1', '1', '0'),
(16, 'Menu No visibles', 'far fa-eye-slash', '#', 8, '0', '1', '0'),
(66, 'Tabla Logica', 'fa fa-sitemap', 'tabla_logica', 4, '1', '0', '0'),
(67, 'Ingresar Datos En Tabla', 'fas fa-file-signature', 'ingresar_datos', 5, '1', '0', '0'),
(68, 'Mantenedor De Clientes', 'fa fa-user', 'cliente', 2, '1', '0', '0'),
(69, 'Mantenedor De Pacientes', 'fa fa-user', 'paciente', 3, '1', '0', '0'),
...
INSERT INTO `persona` (`id`, `nRutPer`, `xNombre`, `xApePat`, `xApeMat`, `cSexo`, `dFecNac`, `xRazSoc`, `xTipoPer`, `cPais`, `xActEco`, `cTipCar`) VALUES
(15, '12872741-8', NULL, NULL, NULL, NULL, NULL, 'HR Cody', 'j', 286, 'Desarrollo', NULL),
(17, '12872741-8', 'heyller', 'reyes', 'aranda', 'M', '1990-02-17', NULL, 'n', NULL, '', 300),
(18, '17108095-9', 'Carlos', 'Sanchez', 'Perez', 'M', NULL, NULL, 'n', NULL, '', 298),
(19, '12460579-2', 'Santos', 'Sandoval', 'Ramirez', 'M', '1970-01-01', NULL, 'n', NULL, '', 298);
...
(129, 'Tipo Documento', 'tipo_documento', 70, 3, '0', '0');
...
(4, '99999999', 'Admin', 'Admin', '', 1, 'admin', '$2a$07$6JI262/2JA73J2K74J5J4uY2g1uZ4W/L66ZESY0AEQInCw90KOyvq', 0, '0'),
...
--
ALTER TABLE `detalle_menu`
  MODIFY `id_detalle_m` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

--
-- AUTO_INCREMENT de la tabla `detalle_sub_m`
--
ALTER TABLE `detalle_sub_m`
  MODIFY `id_detalle_s` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;
...
--
ALTER TABLE `js_menu_asociado`
  MODIFY `id_js` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `sub_menu`
  MODIFY `id_sub_menu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
